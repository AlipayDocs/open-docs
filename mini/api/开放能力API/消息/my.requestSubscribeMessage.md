...
订阅界面是根据当前小程序在 [商家平台](https://mrchportalweb.alipay.com/operation/console/apps) > **运营中心** > 对应小程序详情页 > **消息** > **消息接入** 订阅消息列表中的消息模版 id 来展示对应消息的订阅选项。
...
用户同意订阅消息成功后，可以通过 [服务端](https://opendocs.alipay.com/mini/02cth2) 向支付宝发送对应模版的消息，然后在支付宝首页、消息盒子、APP PUSH 等位置收到消息提醒。也可以在首次用户授权完成（开发接入完成）之后，通过 [商家平台](https://mrchportalweb.alipay.com/operation/console/apps)> **运营中心** > 对应小程序详情页 > **消息** > **消息接入** 订阅消息列表中的“配置发送”发送消息。
...
| thirdTypeAppId | String | 否 | 模板小程序标识，仅在服务商场景下需要传入。 |
