...
| encoding | String | 否 | 指定读取文件的字符编码。如果不传 encoding，则默认以 ArrayBuffer 格式读取文件的二进制内容。<br />可选值：<ul><li>ascii</li><li>base64</li><li>hex</li><li>ucs2/ucs-2/utf16le/utf-16le</li><li>utf-8/utf8</li><li>latin1</li><li>binary：binary 是以二进制数据读取，除 binary 以外，其他都为设置读取文件的字符编码</li></ul> |
