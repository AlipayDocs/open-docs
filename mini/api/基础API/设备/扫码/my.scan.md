...
| **属性** | **类型** | **必填** | **描述** |
| --- | --- | --- | --- |
| scanType | Array | 否 | 扫码识别类型，默认值为 ['qrCode','barCode']。<br />可选值：<br /><li>二维码：'qrCode'。</li><li>条码：'barCode'。</li><li>DM码：'dmCode'。</li><li>PDF417码：'pdf417Code'。</li><li>窄条二维码：'narrowCode'。</li><li>异构码：'hmCode'。</li>|
