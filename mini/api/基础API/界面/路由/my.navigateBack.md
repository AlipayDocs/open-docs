...
# 简介
**my.navigateBack** 是关闭当前页面，返回上一级或多级页面的 API。可通过 [Page.getCurrentPages](https://opendocs.alipay.com/mini/framework/getcurrentpages) 获取当前的页面栈信息，决定需要返回几层。<br />相关问题请参见 [路由FAQ](https://opendocs.alipay.com/mini/api/fu8l65) 。<br />


## 使用限制

<br />此 API 支持个人支付宝小程序、企业支付宝小程序使用。<br />
