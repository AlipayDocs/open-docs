...
| ~enableNodeModuleBabelTransform~ | Boolean | （已废弃，请参考最新的 [项目配置文档](https://opendocs.alipay.com/mini/03dbc3#transpile)） appx 2.0 特性，对 node_modules 中的模块做 babel 编译。<br />**默认值**：false |
