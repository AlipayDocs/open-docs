...
| ~enableNodeModuleBabelTransform~ | Boolean | （已废弃，请参考最新的 [转 ES5 配置](https://opendocs.alipay.com/mini/03dbc3#transpile)） appx 2.0 特性，对 node_modules 中的模块做 babel 编译。<br />**默认值**：false |
...
| debugOptions | Object | 调试/联调的额外配置，生产构建时不生效。详情可查看 [debugOptions](https://opendocs.alipay.com/mini/ide/01s3hm#debugOptions)。<br />**默认值**：null |
