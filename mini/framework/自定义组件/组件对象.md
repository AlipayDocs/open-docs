...
| pageEvents | Object | 否 | 组件所在页面的页面生命周期以及页面事件处理函数声明对象。可查看 Page 的 [events](https://opendocs.alipay.com/mini/framework/page-detail#events) 定义段。 | [2.8.5](https://opendocs.alipay.com/mini/framework/lib-upgrade-v2) |
