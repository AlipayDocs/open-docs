...
| ref | Function | 否 | 指定组件被 ref 引用时的返回值。 | **1.18.0** |
...
| getTabBar | - | 获取自定义 tabBar 实例。基础库 **2.7.20** 起支持。 |

具体使用方式同 [页面运行机制](https://opendocs.alipay.com/mini/framework/page-detail#bf5413ea)。
