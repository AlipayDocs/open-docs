...
| 函数名 | 参数 | 说明 | 最低版本 |
| --- | --- | --- | --- |
| onInit | - | 组件创建时触发。<br/>注：需[开启 component2](https://opendocs.alipay.com/mini/03dbc3#compileOptions) | [1.14.0](https://opendocs.alipay.com/mini/framework/compatibility) |
| deriveDataFromProps | nextProps | 组件创建时和更新前触发。<br/>注：需[开启 component2](https://opendocs.alipay.com/mini/03dbc3#compileOptions) | [1.14.0](https://opendocs.alipay.com/mini/framework/compatibility) |
| didMount | - | 组件创建完毕时触发。 | - |
