...
# 使用示例
下面通过一个示例演示 component2 的使用，具体代码可查看 [https://github.com/ant-mini-program/component2-demo](https://github.com/ant-mini-program/component2-demo)。
```javascript
