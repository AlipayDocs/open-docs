小程序页面文件夹中的 `.json` 文件用于配置当前页面的窗口表现，在页面配置中设置的项会**覆盖** [app.json 应用配置 - window](https://opendocs.alipay.com/mini/framework/app-json#window) 中对应的配置项。
...
其他支持的配置项的详细文档请见：[app.json 应用配置 - window](https://opendocs.alipay.com/mini/framework/app-json#window)。
