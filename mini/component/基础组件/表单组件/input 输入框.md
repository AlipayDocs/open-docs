...
因为使用定位导致键盘把页面 input 内容顶上去了，建议使用 [SearchBar](https://ant-design-mini.antgroup.com/components/input#searchbar-%E6%90%9C%E7%B4%A2%E6%A1%86) 搜索框。<br />需要判断客户端机型为 Android 还是 iOS，从而设置 `enableNative`属性，然后在 app.json 文件 window 对象内设置 `"enableInPageRenderInput":"YES"`。
