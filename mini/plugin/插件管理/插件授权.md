...
| app_refresh_token | String | 40 | 是 | 刷新令牌。开发者可以通过调用 [alipay.open.auth.token.app](https://docs.open.alipay.com/api_9/alipay.open.auth.token.app) 接口进行 app_auth_token 的刷新。 | 201603BBdeb7d0ab1testbe898432a6490dfbX00 |
